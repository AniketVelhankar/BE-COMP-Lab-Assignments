...
#include<ctype.h>
using namespace std;
//class InfixtoPostfix containing data member and member functions
...
void InfixtoPostfix::postfixExpEval() //To evaluate the postfix expression
{
    i=0;
    char ch;
    int op1,op2,res,tot;
...
int InfixtoPostfix::instackprio()
{
    char b;
    b=stk[top];
    switch(b)
...
int InfixtoPostfix::incomingprio(char ch)
{
    switch(ch)
    {
     case '(':return 9; break;
